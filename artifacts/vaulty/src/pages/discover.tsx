...
export default function Discover() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0A0A0A] text-white font-sans overflow-hidden md:pl-[280px]">

      {/* Fixed Header */}
      <header className="flex-shrink-0 z-50 bg-black/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 pt-5 pb-3 space-y-2">
          <img src="/discover-wordmark.png" alt="Discover" className="h-16 w-auto -ml-3" />
